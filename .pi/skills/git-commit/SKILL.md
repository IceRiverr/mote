---
name: git-commit
description: 为 mote 项目提供便捷的 Git 提交功能。当用户想要提交代码、保存开发进度、或使用中文描述提交时自动触发。支持自动添加提交前缀(feat/fix/docs等)、交互式确认、一键推送。
---
...
| `style:` | 样式调整 | 修改 .css/.scss/.html 文件 |
...
```
用户输入 → 显示变更 → 添加文件 → 显示统计 → 提交 → 询问推送 → 完成
```
